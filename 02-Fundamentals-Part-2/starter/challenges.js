...
const calcAverage = (score1, score2, score3) => (Number(score1) + Number(score2) + Number(score3)) / 3;

// 2. Use the function to calculate the average for both teams
const dolphinsAvg = calcAverage(70, 80, 90);
const koalasAvg = calcAverage(10, 100, 30);
...
function checkWinner(teamName1, avgScore1, teamName2, avgScore2) {
    if (avgScore1 >= avgScore2 * 2) {
        return `${teamName1} win (${avgScore1} vs. ${avgScore2})`;
    } else if (avgScore2 >= avgScore1 * 2) {
        return `${teamName2} win (${avgScore2} vs. ${avgScore1})`;
    } else {
        return `It's a draw!`
    }
...
const dolphinsName = 'Dolphins';
const koalasName = 'Koalas';
const dolphinsAvg2 = calcAverage(85, 54, 41);
const koalasAvg2 = calcAverage(23, 34, 27);

console.log(dolphinsAvg2, koalasAvg2);

console.log(checkWinner(dolphinsName, dolphinsAvg2, koalasName, koalasAvg2));
